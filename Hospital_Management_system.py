...
#______________________________________ main window___________________________________________
...
class UI(QMainWindow):
    def __init__(self):
        ...
        #load UI File
        uic.loadUi('Hospital_Management_system.ui',self)
    ...
    def add_doctor(self):
        ...
        speciality = self.specialty_lineEdit.text()
        ...
        columns = [
            ...
            "speciality", "department", "room_number",
